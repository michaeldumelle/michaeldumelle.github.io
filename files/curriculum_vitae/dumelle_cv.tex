...
\documentclass[line, margin, 10pt]{res}\usepackage[]{graphicx}\usepackage[]{color}
...
% Simulate as if there are 7 lines of address (add backslashes if I decide I want a picture)
% 
%\address{Personal Website: \href{https://xtxinverse.netlify.com/}{https://xtxinverse.netlify.com/}}

%\address{1311 NW 29th Street Corvallis, OR 97330}

% Hence the photo would take 7 lines/rows
% \address{\multirow{7}{*}{\includegraphics[width=2.4cm]{CVPic.png}}}
% Uncomment to add a third address

\address{Website: \href{https://michaeldumelle.github.io}{michaeldumelle.github.io}}
\address{E-mail: Dumelle.Michael@epa.gov} 
